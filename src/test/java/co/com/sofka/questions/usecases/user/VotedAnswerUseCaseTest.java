...
class VotedAnswerUseCaseTest {
    ...
    public void setup() {
        ...
        usecase = new VotedAnswerUseCase(userRepository, answerRepository, getCase);
    }
    ...
    public void addAnswerTest() {
        ...
        Mockito.verify(answerRepository, Mockito.times(2)).findById(answerId);
